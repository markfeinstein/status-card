 ...
 */
const xt = globalThis, he = xt.ShadowRoot && (xt.ShadyCSS === void 0 || xt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ue = Symbol(), ye = /* @__PURE__ */ new WeakMap();
let S1 = class {
  constructor(t, i, s) {
  ...
  get styleSheet() {
    ...
    if (he && t === void 0) {
      ...
      s && (t = ye.get(i)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), s && ye.set(i, t));
    }
    return t;
  }
  toString() {
...
const K1 = (e) => new S1(typeof e == "string" ? e : e + "", void 0, ue), Lt = (e, ...t) => {
...
}, be = he ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let i = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: J1, defineProperty: X1, getOwnPropertyDescriptor: Q1, getOwnPropertyNames: ti, getOwnPropertySymbols: ei, getPrototypeOf: ii } = Object, it = globalThis, Le = it.trustedTypes, si = Le ? Le.emptyScript : "", jt = it.reactiveElementPolyfillSupport, gt = (e, t) => e, Tt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? si : null;
      break;
  ...
  return i;
} }, pe = (e, t) => !J1(e, t), Ae = { attribute: !0, type: String, converter: Tt, reflect: !1, useDefault: !1, hasChanged: pe };
...
let ht = class extends HTMLElement {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of s) i.unshift(be(o));
  ...
  _$ET(t, i) {
    ...
    if (o !== void 0 && s.reflect === !0) {
      const a = (((n = s.converter) == null ? void 0 : n.toAttribute) !== void 0 ? s.converter : Tt).toAttribute(i, s.type);
  ...
  _$AK(t, i) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const r = s.getPropertyOptions(o), l = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((n = r.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? r.converter : Tt;
      this._$Em = o;
  ...
  requestUpdate(t, i, s, o = !1, n) {
    ...
    if (t !== void 0) {
      ...
      if (o === !1 && (n = this[t]), s ?? (s = r.getPropertyOptions(t)), !((s.hasChanged ?? pe)(n, i) || s.useDefault && s.reflect && n === ((a = this._$Ej) == null ? void 0 : a.get(t)) && !this.hasAttribute(r._$Eu(t, s)))) return;
      this.C(t, i, s);
    }
...
ht.elementStyles = [], ht.shadowRootOptions = { mode: "open" }, ht[gt("elementProperties")] = /* @__PURE__ */ new Map(), ht[gt("finalized")] = /* @__PURE__ */ new Map(), jt == null || jt({ ReactiveElement: ht }), (it.reactiveElementVersions ?? (it.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ct = globalThis, He = (e) => e, Dt = Ct.trustedTypes, Ve = Dt ? Dt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, x1 = "$lit$", Q = `lit$${Math.random().toFixed(9).slice(2)}$`, k1 = "?" + Q, oi = `<${k1}>`, lt = document, vt = () => lt.createComment(""), yt = (e) => e === null || typeof e != "object" && typeof e != "function", fe = Array.isArray, ni = (e) => fe(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Ut = `[ 	
\f\r]`, mt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, $e = /-->/g, Me = />/g, ot = RegExp(`>|${Ut}(?:([^\\s"'>=/]+)(${Ut}*=${Ut}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), we = /'/g, Ee = /"/g, z1 = /^(?:script|style|textarea|title)$/i, ai = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), m = ai(1), F = Symbol.for("lit-noChange"), z = Symbol.for("lit-nothing"), Se = /* @__PURE__ */ new WeakMap(), at = lt.createTreeWalker(lt, 129);
function T1(e, t) {
...
const ri = (e, t) => {
  ...
  for (let r = 0; r < i; r++) {
    const l = e[r];
    let c, d, h = -1, p = 0;
    for (; p < l.length && (a.lastIndex = p, d = a.exec(l), d !== null); ) p = a.lastIndex, a === mt ? d[1] === "!--" ? a = $e : d[1] !== void 0 ? a = Me : d[2] !== void 0 ? (z1.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = ot) : d[3] !== void 0 && (a = ot) : a === ot ? d[0] === ">" ? (a = o ?? mt, h = -1) : d[1] === void 0 ? h = -2 : (h = a.lastIndex - d[2].length, c = d[1], a = d[3] === void 0 ? ot : d[3] === '"' ? Ee : we) : a === Ee || a === we ? a = ot : a === $e || a === Me ? a = mt : (a = ot, o = void 0);
    const u = a === ot && e[r + 1].startsWith("/>") ? " " : "";
    n += a === mt ? l + oi : h >= 0 ? (s.push(c), l.slice(0, h) + x1 + l.slice(h) + Q + u) : l + Q + (h === -2 ? r : u);
  }
  return [T1(e, n + (e[i] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), s];
};
class bt {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const r = t.length - 1, l = this.parts, [c, d] = ri(t, i);
    if (this.el = bt.createElement(c, s), at.currentNode = this.el.content, i === 2 || i === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (o = at.nextNode()) !== null && l.length < r; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(x1)) {
          const p = d[a++], u = o.getAttribute(h).split(Q), _ = /([.?@])?(.*)/.exec(p);
          l.push({ type: 1, index: n, name: _[2], strings: u, ctor: _[1] === "." ? ci : _[1] === "?" ? di : _[1] === "@" ? hi : It }), o.removeAttribute(h);
        } else h.startsWith(Q) && (l.push({ type: 6, index: n }), o.removeAttribute(h));
        if (z1.test(o.tagName)) {
          const h = o.textContent.split(Q), p = h.length - 1;
          if (p > 0) {
            o.textContent = Dt ? Dt.emptyScript : "";
            for (let u = 0; u < p; u++) o.append(h[u], vt()), at.nextNode(), l.push({ type: 2, index: ++n });
            o.append(h[p], vt());
          }
        }
      } else if (o.nodeType === 8) if (o.data === k1) l.push({ type: 2, index: n });
      else {
        let h = -1;
        for (; (h = o.data.indexOf(Q, h + 1)) !== -1; ) l.push({ type: 7, index: n }), h += Q.length - 1;
      }
      n++;
    }
  }
...
function ut(e, t, i = e, s) {
  ...
  return (o == null ? void 0 : o.constructor) !== n && ((r = o == null ? void 0 : o._$AO) == null || r.call(o, !1), n === void 0 ? o = void 0 : (o = new n(e), o._$AT(e, i, s)), s !== void 0 ? (i._$Co ?? (i._$Co = []))[s] = o : i._$Cl = o), o !== void 0 && (t = ut(e, o._$AS(e, t.values), o, s)), t;
}
class li {
  constructor(t, i) {
  ...
  u(t) {
    ...
    at.currentNode = o;
    let n = at.nextNode(), a = 0, r = 0, l = s[0];
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new pt(n, n.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(n, l.name, l.strings, this, t) : l.type === 6 && (c = new ui(n, this, t)), this._$AV.push(c), l = s[++r];
      }
      a !== (l == null ? void 0 : l.index) && (n = at.nextNode(), a++);
    }
    return at.currentNode = lt, o;
  }
  p(t) {
    let i = 0;
...
class pt {
  ...
  constructor(t, i, s, o) {
    this.type = 2, this._$AH = z, this._$AN = void 0, this._$AA = t, this._$AB = i, this._$AM = s, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, i = this) {
    t = ut(this, t, i), yt(t) ? t === z || t == null || t === "" ? (this._$AH !== z && this._$AR(), this._$AH = z) : t !== this._$AH && t !== F && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ni(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== z && yt(this._$AH) ? this._$AA.nextSibling.data = t : this.T(lt.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var n;
    const { values: i, _$litType$: s } = t, o = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = bt.createElement(T1(s.h, s.h[0]), this.options)), s);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(i);
    else {
      const a = new li(o, this), r = a.u(this.options);
      a.p(i), this.T(r), this._$AH = a;
    }
  }
  _$AC(t) {
    let i = Se.get(t.strings);
    return i === void 0 && Se.set(t.strings, i = new bt(t)), i;
  }
  k(t) {
...
class It {
  ...
  constructor(t, i, s, o, n) {
    this.type = 1, this._$AH = z, this._$AN = void 0, this.element = t, this.name = i, this._$AM = o, this.options = n, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(new String()), this.strings = s) : this._$AH = z;
  }
  _$AI(t, i = this, s, o) {
    ...
    if (n === void 0) t = ut(this, t, i, 0), a = !yt(t) || t !== this._$AH && t !== F, a && (this._$AH = t);
      ...
      const r = t;
      let l, c;
      for (t = n[0], l = 0; l < n.length - 1; l++) c = ut(this, r[s + l], i, l), c === F && (c = this._$AH[l]), a || (a = !yt(c) || c !== this._$AH[l]), c === z ? t = z : t !== z && (t += (c ?? "") + n[l + 1]), this._$AH[l] = c;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
const pi = { I: pt }, Nt = Ct.litHtmlPolyfillSupport;
Nt == null || Nt(bt, pt), (Ct.litHtmlVersions ?? (Ct.litHtmlVersions = [])).push("3.3.3");
const fi = (e, t, i) => {
...
var E1;
R._$litElement$ = !0, R.finalized = !0, (E1 = rt.litElementHydrateSupport) == null || E1.call(rt, { LitElement: R });
const Wt = rt.litElementPolyfillSupport;
Wt == null || Wt({ LitElement: R });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const mi = { attribute: !0, type: String, converter: Tt, reflect: !1, hasChanged: pe }, _i = (e = mi, t, i) => {
...
function M(e) {
  return (t, i) => typeof i == "object" ? _i(e, t, i) : ((s, o, n) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const me = { ATTRIBUTE: 1, CHILD: 2 }, Zt = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Gt = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: gi } = pi, xe = (e) => e, ke = () => document.createComment(""), _t = (e, t, i) => {
  var n;
  const s = e._$AA.parentNode, o = t === void 0 ? e._$AB : t._$AA;
  if (i === void 0) {
    const a = s.insertBefore(ke(), o), r = s.insertBefore(ke(), o);
    i = new gi(a, r, e, e.options);
  } else {
    const a = i._$AB.nextSibling, r = i._$AM, l = r !== e;
    if (l) {
      let c;
      (n = i._$AQ) == null || n.call(i, e), i._$AM = e, i._$AP !== void 0 && (c = e._$AU) !== r._$AU && i._$AP(c);
    }
    if (a !== o || l) {
      let c = i._$AA;
      for (; c !== a; ) {
        const d = xe(c).nextSibling;
        xe(s).insertBefore(c, o), c = d;
      }
    }
  }
  return i;
}, nt = (e, t, i = e) => (e._$AI(t, i), e), Ci = {}, vi = (e, t = Ci) => e._$AH = t, yi = (e) => e._$AH, qt = (e) => {
...
const ze = (e, t, i) => {
  ...
  update(e, [t, i, s]) {
    const o = yi(e), { values: n, keys: a } = this.dt(t, i, s);
    if (!Array.isArray(o)) return this.ut = a, n;
    const r = this.ut ?? (this.ut = []), l = [];
    let c, d, h = 0, p = o.length - 1, u = 0, _ = n.length - 1;
    for (; h <= p && u <= _; ) if (o[h] === null) h++;
    else if (o[p] === null) p--;
    else if (r[h] === a[u]) l[u] = nt(o[h], n[u]), h++, u++;
    else if (r[p] === a[_]) l[_] = nt(o[p], n[_]), p--, _--;
    else if (r[h] === a[_]) l[_] = nt(o[h], n[_]), _t(e, l[_ + 1], o[h]), h++, _--;
    else if (r[p] === a[u]) l[u] = nt(o[p], n[u]), _t(e, o[h], o[p]), p--, u++;
    else if (c === void 0 && (c = ze(a, u, _), d = ze(r, h, p)), c.has(r[h])) if (c.has(r[p])) {
      const b = d.get(a[u]), g = b !== void 0 ? o[b] : null;
      if (g === null) {
        const f = _t(e, o[h]);
        nt(f, n[u]), l[u] = f;
      } else l[u] = nt(g, n[u]), _t(e, o[h], g), o[b] = null;
      u++;
    } else qt(o[p]), p--;
    else qt(o[h]), h++;
    for (; u <= _; ) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const D1 = "important", bi = " !" + D1, S = Zt(class extends Gt {
  constructor(e) {
    var t;
  ...
  update(e, [t]) {
    ...
    for (const s in t) {
      ...
      if (o != null) {
        ...
        s.includes("-") || n ? i.setProperty(s, n ? o.slice(0, -11) : o, n ? D1 : "") : i[s] = o;
      }
    }
    return F;
  }
 ...
 */
const Kt = (e) => e ?? z;
var Te = Number.isNaN || function(t) {
...
const _e = [
  ...
  if (n && n !== "default" && ((p = t == null ? void 0 : t.themes) != null && p[n])) {
    ...
    l = { ...l, ...f }, g && (a && g.dark ? l = { ...l, ...g.dark } : !a && g.light && (l = { ...l, ...g.light }));
  } else if (!n && (!((u = e.__themes) != null && u.keys) || e.__themes.keys.size === 0))
    return;
  const c = ((_ = e.__themes) == null ? void 0 : _.keys) || /* @__PURE__ */ new Set(), d = new Set(Object.keys(l));
...
}, T = (e) => e.substr(0, e.indexOf(".")), co = (e) => (t, i) => e.includes(t, i), ge = "unavailable", ho = "unknown", uo = "off", po = [ge, ho], fo = co(po), mo = (e) => {
...
const go = (e, t = "_") => {
  ...
  let a;
  return e === "" ? a = "" : (a = e.toString().toLowerCase().replace(o, (r) => s.charAt(i.indexOf(r))).replace(/[а-я]/g, (r) => n[r] || "").replace(/(\d),(?=\d)/g, "$1").replace(/[^a-z0-9]+/g, t).replace(new RegExp(`(${t})\\1+`, "g"), "$1").replace(new RegExp(`^${t}+`), "").replace(new RegExp(`${t}+$`), ""), a === "" && (a = "unknown")), a;
}, Co = (e) => {
  const t = Number(e);
  if (!isNaN(t))
...
), Vo = (e, t) => e < t ? -1 : e > t ? 1 : 0, O1 = (e, t, i = void 0) => Intl != null && Intl.Collator ? Ho(i).compare(e, t) : Vo(e.toLowerCase(), t.toLowerCase()), kt = (e, t) => {
  if (e === t)
    return !0;
...
function I1(e, t, i, s, o) {
  const n = s.area && s.area.length > 0 ? Array.isArray(s.area) ? s.area : [s.area] : null, a = s.floor && s.floor.length > 0 ? Array.isArray(s.floor) ? s.floor : [s.floor] : null, r = s.label && s.label.length > 0 ? Array.isArray(s.label) ? s.label : [s.label] : null, l = s.hiddenAreas || [], c = s.hiddenLabels || [], d = s.hiddenEntities || [], h = new Set(l), p = new Set(c), u = new Set(d), _ = new Set(o), b = new Map(Object.values(t).map((f) => [f.id, f])), g = new Map(
  ...
  return Object.values(e).filter((f) => {
    ...
    if (!(f.area_id != null || v && v.area_id != null) || r && !((((y = f.labels) == null ? void 0 : y.some((N) => r.includes(N))) ?? !1) || (((V = v == null ? void 0 : v.labels) == null ? void 0 : V.some((N) => r.includes(N))) ?? !1)) || n && !(f.area_id !== void 0 && f.area_id !== null && n.includes(f.area_id) || v && v.area_id !== void 0 && v.area_id !== null && n.includes(v.area_id)))
      return !1;
    if (a) {
      const O = f.area_id ? g.get(f.area_id) : void 0, N = v != null && v.area_id ? g.get(v.area_id) : void 0;
      if (!(O && a.includes(O) || N && a.includes(N))) return !1;
    }
    return h.size && (f.area_id && h.has(f.area_id) || v && v.area_id && h.has(v.area_id)) || (x = f.labels) != null && x.some((O) => p.has(O)) || u.has(f.entity_id) ? !1 : !f.hidden;
  }).map((f) => f.entity_id);
}
function P1(e, t) {
  const i = {};
...
function ko(e, t) {
  ...
  try {
    ...
    if (customElements.get(a)) {
      ...
      return typeof r.setConfig == "function" && r.setConfig(t), r.hass = e, (i = r.setAttribute) == null || i.call(r, "data-hui-card", ""), r;
    }
  } catch (o) {
...
async function Z1(e, t, i = !1) {
  ...
  try {
    ...
    if (a != null && a.createCardElement) {
      const r = a.createCardElement(t);
      return r.hass = e, (o = r.setAttribute) == null || o.call(r, "data-hui-card", ""), r;
    }
  } catch (a) {
    console.debug("status-card: Failed to load card helpers", a);
  }
  try {
    const a = t.type || "tile", r = typeof a == "string" && a.startsWith("custom:"), l = r ? a.slice(7) : `hui-${a}-card`;
...
const et = {
  ...
  lock: { on: s1, off: i1 },
  light: { on: hs, off: us },
  media_player: { on: Ri, off: Fi },
  climate: { on: Ns, off: Ws },
  ...
  person: { on: De, off: Oe },
  device_tracker: { on: De, off: Oe },
  valve: { on: Ys, off: m1 },
  water_heater: { on: eo, off: so },
  remote: { on: Ms, off: ws },
  update: { on: Pe, off: Ze },
  air_quality: { on: Ie, off: Ie },
  camera: { on: Pi, off: Zi },
  calendar: { on: Re, off: Fe },
  scene: { on: vs, off: ys },
  notifications: { on: Ti, off: Be },
  sensor: { on: Xe, off: Xe },
  script: { on: h1, off: h1 },
  tags: { on: p1, off: p1 },
  select: { on: Mt, off: Mt },
  ...
  input_datetime: { on: $t, off: $t },
  input_number: { on: wt, off: wt },
  input_select: {
    on: Mt,
    off: Mt
  },
  input_text: { on: Et, off: Et },
  stt: { on: $s, off: Vs },
  sun: { on: v1, off: C1 },
  text: { on: Et, off: Et },
  date: { on: Re, off: Fe },
  ...
  tts: { on: _1, off: g1 },
  wake_word: { on: ms, off: _s },
  weather: { on: oo, off: C1 },
  zone: { on: o1, off: n1 },
...
const B = (e, t) => e ? typeof e == "object" ? Object.entries(e).reduce(
  (o, [n, a]) => {
    const r = n.startsWith("--") ? n : n.replace(/-([a-z])/g, (l, c) => c.toUpperCase());
    return o[r] = String(a), o;
  },
  {}
) : (e.trim(), e.replace(/\/\*[\s\S]*?\*\//g, "").replace(/\n/g, " ").split(";").map((o) => o.trim()).filter((o) => o && o.includes(":")).reduce(
  (o, n) => {
    const a = n.split(":"), r = a[0], l = a.slice(1).join(":");
    if (r && l !== void 0) {
      const c = r.trim(), d = c.startsWith("--") ? c : c.replace(/-([a-z])/g, (h, p) => p.toUpperCase());
      o[d] = l.trim();
    }
    return o;
  },
  {}
)) : {}, Bo = (e, t, i) => t && t._parsedCss ? t._parsedCss : e ? B(e) : {}, Ro = Lt`
  ...
  return (e ?? []).forEach((i) => {
    ...
    if (i.type) {
      ...
      if ((s = a.styles) != null && s.card && (a._parsedCss = B(a.styles.card)), (o = a.styles) != null && o.button) {
        const r = B(a.styles.button);
        a._parsedCss = { ...a._parsedCss, ...r };
      }
...
function B1(e, t, i, s, o) {
  ...
  const r = (n == null ? void 0 : n.invert) === !0 ? "off" : "on";
  let l = t;
  if (!i && t.includes(".") && (l = t.split(".")[0]), et && et[l]) {
    const c = et[l];
    if (i && typeof c == "object") {
      ...
      if (d) {
        ...
        if (typeof d == "object" && "on" in d && "off" in d)
          return d[r] || d.on || d.off;
      }
    }
    if (typeof c == "object" && "on" in c && "off" in c)
      return c[r] || c.on || c.off;
...
function se(e, t, i, s, o, n, a, r) {
  const l = P(i, s), c = Ht(t, l, r), d = (c == null ? void 0 : c.invert) === !0;
  switch (i) {
    case "device_tracker":
      return jo(e, d);
    case "lock":
...
function w1(e, t, i, s, o, n, a) {
  n.stopPropagation();
  const r = n.detail.action, l = St(i, r, s, o), c = typeof l == "string" && l === "more-info" || typeof l == "object" && (l == null ? void 0 : l.action) === "more-info", d = typeof l == "string" && l === "toggle" || typeof l == "object" && (l == null ? void 0 : l.action) === "toggle";
  if (s.includes(".")) {
    const h = s, p = T(h);
    if (d) {
  ...
  So(
    ...
    t,
    {
      tap_action: St(i, "tap", s, o),
      hold_action: St(i, "hold", s, o),
      double_tap_action: St(
        i,
        "double_tap",
        s,
        o
...
const Ko = [
    ...
    super(...arguments), this.open = !1, this.title = "", this.content = "", this.entities = [], this._showAll = !1, this._cardEls = /* @__PURE__ */ new Map(), this._lastEntityIds = [], this._activeEntities = [], this._allEntities = [], this._currentEntitiesCache = [], this._opener = null, this._handleMoreInfo = (t) => {
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          const l = Ot(n, s);
          return a.sort((c, d) => {
            const h = this._isActive(c) ? 0 : 1, p = this._isActive(d) ? 0 : 1;
            if (h !== p) return h - p;
            const u = T(c.entity_id), _ = T(d.entity_id), b = o ? j(o, c.state, u) : c.state, g = o ? j(o, d.state, _) : d.state, f = (b || "").localeCompare(g || "");
            return f !== 0 ? f : l(c.entity_id, d.entity_id);
          });
        }
        const r = Ot(n, s);
        return a.sort((l, c) => r(l.entity_id, c.entity_id));
      }
    ), this._areaMapMemo = H(
      (t) => {
      ...
      (t, i, s) => {
        ...
        return Array.from(o.entries()).sort(
          ([a], [r]) => {
            var d, h;
            const l = ((d = i.get(a)) == null ? void 0 : d.toLowerCase()) ?? (a === "unassigned" ? "unassigned" : a), c = ((h = i.get(r)) == null ? void 0 : h.toLowerCase()) ?? (r === "unassigned" ? "unassigned" : r);
  ...
  _getPopupCardConfig(t) {
    ...
    if (this.selectedGroup !== void 0 && ((b = i._config.content) != null && b[this.selectedGroup])) {
      const E = i._config.content[this.selectedGroup], y = i.getCustomizationForType(E);
    ...
    const s = T(t.entity_id), o = this.selectedDomain || s, n = this.selectedDomain ? this.selectedDeviceClass : (v = (C = (f = (g = this.hass) == null ? void 0 : g.states) == null ? void 0 : f[t.entity_id]) == null ? void 0 : C.attributes) == null ? void 0 : v.device_class, a = P(o, n), r = typeof (i == null ? void 0 : i.getCustomizationForType) == "function" ? i.getCustomizationForType(a) : void 0, l = r == null ? void 0 : r.popup_card, c = l && typeof l.type == "string" && l.type || "tile", d = c === "tile" ? Io[s] ?? {} : {};
    let h = {};
    if (l && typeof l == "object") {
      const { type: E, entity: y, ...V } = l;
      h = V;
    } else
      h = {};
    const p = {
      ...
      ...d,
      ...h
    }, u = this._configHash(p), _ = this._popupCardConfigCache.get(t.entity_id);
  ...
  shouldUpdate(t) {
    ...
    if (t.has("hass")) {
      ...
      if (!o || !s || s.themes !== o.themes || s.language !== o.language || s.localize !== o.localize || this._hasRelevantStateChanged(s, o)) {
        ...
        const n = this._currentEntitiesCache.map((l) => l.entity_id).sort(), a = (this._lastEntityIds || []).slice().sort();
        return !(n.length === a.length && n.every((l, c) => l === a[c]));
      }
      return !1;
    }
  ...
  _getOrCreateCard(t) {
    ...
    const r = document.createElement("div");
    return r.classList.add("card-placeholder"), r.setAttribute("data-hui-card", ""), this._cardEls.set(i, r), this._createCardElement(this.hass, s).then((l) => {
      try {
        this._cardEls.get(i) === r && (r.replaceWith(l), this._cardEls.set(i, l), this._cardElementCache.set(i, { hash: o, el: l })), l.hass = this.hass;
      } catch (c) {
        console.debug("status-card: Failed to create popup card for entity:", i, c);
      }
    }), this._cardElementCache.set(i, { hash: o, el: r }), r;
  }
  willUpdate(t) {
  ...
  _isEntityActive(t) {
    var r;
    const i = this.selectedDomain || T(t.entity_id), s = this.selectedDeviceClass || t.attributes.device_class, o = P(i, s), n = typeof ((r = this.card) == null ? void 0 : r.getCustomizationForType) == "function" ? this.card.getCustomizationForType(o) : void 0, a = (n == null ? void 0 : n.invert) === !0;
    return zt(t, i, s, a);
  }
  _getCurrentEntities() {
  ...
  render() {
    ...
    const t = this._getGroupCustomization(), i = (t == null ? void 0 : t.list_mode) ?? this.card.list_mode, s = (t == null ? void 0 : t.columns) ?? this.card._config.columns ?? 4, o = i ? 1 : s, n = this.selectedDomain, a = this.selectedDeviceClass, r = this.selectedGroup, l = this.card, c = this._areaMapMemo((y = this.hass) == null ? void 0 : y.areas);
    let d = this._entities, h = !1;
    r === void 0 && n && (h = !0);
    const p = this.sortEntitiesForPopup(d), u = new Set(d.map((L) => L.entity_id));
    ...
    ), b = (t == null ? void 0 : t.ungroup_areas) === !0 || ((V = l == null ? void 0 : l._config) == null ? void 0 : V.ungroupAreas) === !0 || ((x = l == null ? void 0 : l._config) == null ? void 0 : x.ungroup_areas) === !0 || ((O = l == null ? void 0 : l._config) == null ? void 0 : O.area_grouping) !== void 0 && ((N = l == null ? void 0 : l._config) == null ? void 0 : N.area_grouping) === !1, g = _.length ? Math.max(..._.map(([, L]) => L.length)) : 0, f = b ? Math.min(o, Math.max(1, d.length)) : Math.min(o, Math.max(1, g));
    this.style.setProperty("--columns", String(f));
    const C = P(n, a), v = typeof (l == null ? void 0 : l.getCustomizationForType) == "function" ? l.getCustomizationForType(C) : void 0, E = (v == null ? void 0 : v.invert) === !0;
    return m`
      <ha-adaptive-dialog
        .hass=${this.hass}
        .open=${this.open}
      ...
      if (L !== void 0 && ((I = (Y = ct._config) == null ? void 0 : Y.content) != null && I[L])) {
        const N1 = ct._config.content[L];
      ...
      return this.selectedDomain && this.selectedDeviceClass ? this.computeLabel(
        ...
        ${h ? m`
              ...
              >
                ...
                ${this._isToggleableDomain ? m`<ha-dropdown-item
                      graphic="icon"
      ...
      "ui.panel.lovelace.editor.card.entities.name"
        ...
        <div class="dialog-content scrollable ha-scrollbar" @hass-more-info=${this._handleMoreInfo}>
          ${(Ft = this.card) != null && Ft.list_mode ? b ? m`
                  <ul class="entity-list">
                    ${tt(
      p,
      (L) => L.entity_id,
      (L) => m`<li class="entity-item">- ${L.entity_id}</li>`
    )}
                  </ul>
                ` : m`
                  <ul class="entity-list">
        ...
        return m`
                          <li class="entity-item">
                            <div class="area-header">
                              <h4>${Y}:</h4>
                              ${this._isToggleableDomain ? m`<ha-icon-button
...
D([
  A()
], G.prototype, "_showAll");
D([
  A()
], G.prototype, "selectedGroup");
D([
  A()
], G.prototype, "_entities");
customElements.define("status-card-popup", G);
class ft extends R {
  constructor() {
  ...
  render() {
    var a, r;
    if (!this.hass || !this.card) return m``;
...
const Yo = (e, t, i, s) => s ? [] : Object.values(e).filter(
  ...
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    if (r && r.state !== void 0 && r.invert_state !== void 0) {
      const g = r.invert_state === "true", f = a.state === r.state;
      if (!g && !f || g && f) return o;
    }
    const l = s.indexOf(n), c = l >= 0 ? l : 0, d = B1(
      e,
      n,
      void 0,
      a,
      i
    ), h = re(e, n, void 0, a, i) ?? a.attributes.friendly_name ?? n, p = Vt(
      e,
      "icon_color",
      n,
      void 0,
      i
    ) || ((r == null ? void 0 : r.activate_state_color) ?? e.activate_state_color ? Ao(a) : void 0) || e.color, u = Fo(
      e,
      n,
      void 0,
      i
  ...
  if (Array.isArray(e.filters))
    l = e.filters.filter((c) => ce.includes(c.key));
  else {
    const c = e;
    ce.forEach((d) => {
      c[d] !== void 0 && l.push({ key: d, value: c[d] });
    });
  }
  return !l.length && !o.length ? t.map((c) => c.entity_id) : t.filter((c) => {
  ...
  if (Array.isArray(t.filters))
    r = t.filters.filter((l) => !ce.includes(l.key));
  else {
    const l = t;
    [
      "state",
      ...
      l[c] !== void 0 && r.push({ key: c, value: l[c] });
    });
  }
  return r.length ? i.map((l) => s[l]).filter((l) => l ? r.every(
    (c) => U1(e, l, c, {
      entityMap: o,
      deviceMap: n,
      areaMap: a
    })
  ) : !1) : i.map((l) => s[l]).filter((l) => !!l);
};
function sn(e, t, i, s, o) {
  var p;
  const n = e.__registryEntities || [], a = e.__registryDevices || [], r = e.__registryAreas || [], l = i || new Map(n.map((u) => [u.entity_id, u])), c = s || new Map(a.map((u) => [u.id, u])), d = o || new Map(r.map((u) => [u.area_id, u])), h = F1(
    t,
    n,
    a,
    r,
...
function oe(e, t) {
  ...
  const i = t.match(/^([<>]=?)?\s*(\d+)$/);
  if (!i) return !1;
  const [, s, o] = i, n = parseInt(o, 10), a = /* @__PURE__ */ new Date(), r = new Date(e), l = (a.getTime() - r.getTime()) / 6e4;
  switch (s) {
    case ">":
      return l > n;
    case ">=":
...
const on = {
  ...
  label: (e, t, { deviceMap: i, card: s }, o) => {
    ...
    if ((r = o == null ? void 0 : o.labels) != null && r.some(a)) return !0;
    if (o != null && o.device_id) {
      const c = i == null ? void 0 : i.get(o.device_id);
      if ((l = c == null ? void 0 : c.labels) != null && l.some(a)) return !0;
    }
    return !1;
  },
  floor: (e, t, { entityMap: i, deviceMap: s, areaMap: o }, n) => {
    ...
    if (!a && (n != null && n.device_id) && (a = (l = s == null ? void 0 : s.get(n.device_id)) == null ? void 0 : l.area_id), !a) return !1;
    const r = o == null ? void 0 : o.get(a);
    return k(r == null ? void 0 : r.floor_id, t);
  },
  ...
  last_changed: (e, t) => typeof t == "string" && /^[<>]=?\s*\d+$/.test(t) ? oe(e.last_changed, t) : k(e.last_changed, t),
  last_updated: (e, t) => typeof t == "string" && /^[<>]=?\s*\d+$/.test(t) ? oe(e.last_updated, t) : k(e.last_updated, t),
  last_triggered: (e, t) => typeof t == "string" && /^[<>]=?\s*\d+$/.test(t) ? oe(e.attributes.last_triggered, t) : k(e.attributes.last_triggered, t),
  group: (e, t, { card: i }) => {
    var o, n;
...
function U1(e, t, i, s) {
  var a, r;
  const o = ((a = s.entityMap) == null ? void 0 : a.get(t.entity_id)) || ((r = s.entities) == null ? void 0 : r.find((l) => l.entity_id === t.entity_id)), n = on[i.key];
  return n ? n(t, i.value, { ...s, card: e }, o) : !0;
}
var nn = Object.defineProperty, an = Object.getOwnPropertyDescriptor, w = (e, t, i, s) => {
...
let $ = class extends R {
  constructor() {
    super(...arguments), this.entitiesByDomain = {}, this.selectedDomain = null, this.selectedDeviceClass = null, this.hiddenEntities = [], this.hiddenLabels = [], this.hiddenAreas = [], this.hide_person = !1, this.hide_content_name = !0, this.list_mode = !1, this.badge_mode = !1, this.no_background = !1, this.badge_color = "", this.badge_text_color = "", this.selectedGroup = null, this._shouldHideCard = !1, this.__registryEntities = [], this.__registryDevices = [], this.__registryAreas = [], this.__registryFetchInProgress = !1, this._parsedGlobalCss = {}, this._parsedGlobalIconCss = {}, this._parsedGlobalCardCss = {}, this._parsedGlobalNameCss = {}, this._parsedGlobalStateCss = {}, this._computeIncludedIdsMemo = H(
    ...
    ), this._customizationIndexMemo = H(G1), this._computePersonIdsMemo = H(Yo), this._mapPersonIdsToStatesMemo = H(
      (e, t) => Jo(e, t),
      (e, t) => {
        const [i, s] = e, [o, n] = t;
        if (i !== o) return !1;
      ...
      Xo,
      (e, t) => {
        const [i, s, o] = e, [n, a, r] = t;
        if (i !== n || o !== r) return !1;
        const l = i.extra_entities;
        if (!l) return !0;
        for (const c of l)
          if (s[c] !== a[c]) return !1;
        return !0;
      }
    ), this._computeGroupItemsMemo = H(Qo), this._computeDomainItemsMemo = H(tn), this._computeDeviceClassItemsMemo = H(en), this._computeEntityMap = H(
      ...
      (e, t, i, s, o) => {
        const n = /* @__PURE__ */ new Map(), a = this._computeEntityMap(t), r = this._computeDeviceMap(i), l = this._computeAreaMap(s);
        return e.forEach((c) => {
          const d = F1(
            c,
            t,
      ...
      (e, t, i, s, o, n) => {
        const a = /* @__PURE__ */ new Map(), r = {
          ...
          __registryAreas: n,
          hass: { states: t }
        }, l = this._computeEntityMap(s), c = this._computeDeviceMap(o), d = this._computeAreaMap(n);
        return i.forEach((h) => {
          const p = e.get(h.group_id) || [], u = j1(
            r,
            h,
            p,
            t,
  ...
  shouldUpdate(e) {
    ...
    if (e.has("_config") || e.has("selectedDomain") || e.has("selectedDeviceClass") || e.has("selectedGroup") || e.has("list_mode") || e.has("badge_mode") || e.has("_shouldHideCard") || e.has("__registryEntities") || e.has("__registryDevices") || e.has("__registryAreas")) return !0;
    const t = e.get("hass");
  ...
  _entitiesByDomain() {
    var h, p, u, _;
    const e = this.hass.entities || [], t = this.hass.devices || [], i = this.hass.areas || [], s = ((h = this.hass) == null ? void 0 : h.states) || {}, o = ((p = this._config) == null ? void 0 : p.area) || null, n = ((u = this._config) == null ? void 0 : u.floor) || null, a = ((_ = this._config) == null ? void 0 : _.label) || null, r = this.hiddenAreas, l = this.hiddenLabels, c = this.hiddenEntities, d = this._computeIncludedIdsMemo(
      e,
      t,
      i,
      o,
  ...
  _openDomainPopup(e) {
    ...
    let i = [], s = [];
    if (typeof e == "number") {
      const d = (r = this._config.content) == null ? void 0 : r[e], h = (l = this._config.rulesets) == null ? void 0 : l.find(
        (p) => p.group_id === d
      );
      if (h) {
        const p = this._computeEntityMap(this.__registryEntities), u = this._computeDeviceMap(this.__registryDevices), _ = this._computeAreaMap(this.__registryAreas);
        s = sn(
          this,
          h,
          p,
  ...
  _hasContent() {
    ...
    if (e.length > 0 && e.some((a) => {
      var l;
      const r = (l = this.hass) == null ? void 0 : l.states[a.panel];
    ...
    for (const n of o) {
      ...
      const r = n.deviceClass ? `${n.domain} - ${n.deviceClass}` : n.domain, l = this.getCustomizationForType(r);
      if (this._config.show_total_entities || (l == null ? void 0 : l.show_total_entities) === !0) return !0;
      const d = (l == null ? void 0 : l.invert) === !0;
      if (a.filter(
        (p) => zt(
          p,
          n.domain,
  ...
  _computeTabStyles(e, t = "domain", i) {
    const s = this._computeActionHandler(
      H1((e == null ? void 0 : e.hold_action) ?? this._config.hold_action),
      H1(
    ...
    }), { badgeStyles: a } = this._computeBadgeStyles(e), r = this._computeButtonStyles(e), l = this._computeCustomIconStyles(e), c = (e == null ? void 0 : e.badge_mode) ?? this.badge_mode;
    return {
      ah: s,
      contentClasses: o,
      iconStyles: n,
  ...
  renderExtraTab(e) {
    const { panel: t, icon: i, name: s, color: o, icon_css: n, background_color: a } = e, r = this.hass.states[t], l = this.getCustomizationForType(t), c = this._handleDomainAction(t), {
      ah: d,
      contentClasses: h,
      iconStyles: p,
      badgeStyles: u,
      ...
      color: o,
      background_color: a
    }), f = (l == null ? void 0 : l.state_content) ?? "state";
    return m`
      <ha-tab-group-tab
        slot="nav"
        panel=${t}
        ...
        class=${g ? "badge-mode" : ""}
        style=${S(u)}
        data-badge=${Kt(g ? "1" : void 0)}
      >
        <div
          class="extra-entity ${dt(h)}"
          style=${S(_)}
        >
          <div
            class="entity-icon"
            style=${S({ ...p, ...b })}
          >
            ${i.startsWith("/") || i.startsWith("http") ? m`<img
                  src=${i}
                  alt=${s}
                  style="border-radius:${this._config.square ? "20%" : "50%"};object-fit:cover;"
                />` : i.startsWith("M") ? m`<ha-svg-icon
                    .path=${i}
                    style="${n || ""}"
                  ></ha-svg-icon>` : m`<ha-state-icon
                    .hass=${this.hass}
                    .stateObj=${r}
                    .icon=${i}
                    data-domain=${T(t)}
          ...
          ${g ? "" : m`<div class="entity-info">
                ${this.hide_content_name ? "" : m`<div
                      class="entity-name"
  ...
  renderGroupTab(e, t) {
    ...
    const n = e.group_id || `${this.hass.localize("component.group.entity_component._.name")} ${t + 1}`, a = e.group_icon || ts, r = M1(
      this._config,
      n,
      void 0,
      this._customizationIndexMemo(this._config.customization)
      ...
      >
        ...
        >
          <div
            ...
            style=${S({ ...u, ...g })}
          >
            ${a.startsWith("M") ? m`<ha-svg-icon .path=${a}></ha-svg-icon>` : m`<ha-icon icon=${a}></ha-icon>`}
          </div>
          ${f ? "" : m`<div class="entity-info">
                ${this.hide_content_name ? "" : m`<div
                      class="entity-name"
                      style=${S(this._parsedGlobalNameCss)}
                    >
  ...
  renderItemTab(e) {
    ...
    }), f = re(this._config, t, i) || this.computeLabel({ name: i || t }), C = this._shouldUseActiveBadgeCount(t, i) ? s.length : a.length;
    let v;
    return this._shouldShowTotalNumbers(t, i) ? v = `${s.length}/${o.length} ${se(
      this.hass,
      this._config,
      t,
      i
    )}` : this._shouldShowTotalEntities(t, i) ? v = `${o.length}` : v = `${s.length} ${se(
      this.hass,
      this._config,
      t,
      i
      ...
      >
        ...
        >
          ...
          >
            ${(() => {
      const E = B1(this._config, t, i);
      return E.startsWith("M") ? m`<ha-svg-icon .path=${E}></ha-svg-icon>` : m`<ha-icon icon=${E}></ha-icon>`;
    })()}
          </div>
          ${g ? "" : m`<div class="entity-info">
                ${this.hide_content_name ? "" : m`<div
  ...
  render() {
    ...
    return m`
      ...
      (r) => {
        var C, v, E;
        const l = this.hass.states[r.entity_id], c = (l == null ? void 0 : l.state) !== "home", d = {
          horizontal: this._config.content_layout === "horizontal"
        }, h = {
          "border-radius": (C = this._config) != null && C.square ? "20%" : "50%",
          filter: c ? "grayscale(100%)" : "none"
        }, p = this._config.person_home_color, u = this._config.person_away_color, _ = this._config.person_home_icon || "mdi:home", b = this._config.person_away_icon || "mdi:home-export-outline", g = c ? u || "red" : p || "green", f = c ? b : _;
        return m`
                <ha-tab-group-tab
                  slot="nav"
                ...
                >
                  ${this.badge_mode ? m`<div
                        class="person-badge"
                        style=${S({
          "--status-card-badge-color": `var(--${g}-color)`,
          "--status-card-badge-text-color": this.badge_text_color ? `var(--${this.badge_text_color}-color)` : void 0
        })}
                      >
                        ${f.startsWith("M") ? m`<ha-svg-icon .path=${f}></ha-svg-icon>` : m`<ha-icon icon=${f}></ha-icon>`}
                      </div>` : ""}
                  <div class="entity ${dt(d)}">
                    <div class="entity-icon" style=${S(h)}>
                      ${r.attributes.entity_picture ? m`<img
                            src=${r.attributes.entity_picture}
                            alt=${r.attributes.friendly_name || r.entity_id}
                            style=${S(h)}
                          />` : (v = r.attributes.icon) != null && v.startsWith("M") ? m`<ha-svg-icon
                              class="center"
                    ...
                    ${this.badge_mode ? "" : m`<div class="entity-info">
                          ${this.hide_content_name ? "" : m`<div class="entity-name">
                                ${((E = r.attributes.friendly_name) == null ? void 0 : E.split(
          " "
        )[0]) || ""}
                              </div>`}
...
function rn(e, t, i, s, o) {
  const n = (d, h, p) => At(e, d, h, p), a = n({ name: "area" }), r = n({ name: "floor" }), l = n({ name: "name" }), c = n({ name: "state" });
  return [
    {
      name: "person",
      // @ts-ignore
...
var fn = Object.defineProperty, mn = Object.getOwnPropertyDescriptor, K = (e, t, i, s) => {
      ...
      ${this._activeTab === "style" ? m`
            <ha-alert alert-type="info" title="Style Guide">
              ...
              <ul>
                ...
                ${this.getSchema === "entity" ? m`<li><b>name</b>: Item Name (Label)</li>` : m``}
              </ul>
              <p>
...
var _n = Object.defineProperty, gn = Object.getOwnPropertyDescriptor, Rt = (e, t, i, s) => {
...
let q = class extends R {
  ...
  _updateAreaFloorInConfig() {
    ...
    this._config.filter === "area" && this._config.floor !== void 0 ? (this._config = ne(this._config, "floor"), Z(this, "config-changed", { config: this._config })) : this._config.filter === "floor" && this._config.area !== void 0 && (this._config = ne(this._config, "area"), Z(this, "config-changed", { config: this._config }));
  }
  async updated(e) {
    super.updated(e);
    let t = !1;
    if (!(!this.hass || !this._config) && e.has("_config")) {
      if (this._updateAreaFloorInConfig(), (this._config.label_filter === !1 && this._config.label !== void 0 || Array.isArray(this._config.label) && this._config.label.length === 0) && (this._config = ne(this._config, "label"), t = !0), this._config.hide_filter && !["entity", "label", "area"].includes(this._config.hide_filter)) {
      ...
      const i = e.get("_config"), s = (i == null ? void 0 : i.extra_entities) ?? [], o = this._config.extra_entities ?? [], n = (i == null ? void 0 : i.content) ?? [], a = this._config.content ?? [], r = Array.isArray(this._config.area) ? [...this._config.area] : this._config.area ? [this._config.area] : [], l = Array.isArray(this._config.floor) ? [...this._config.floor] : this._config.floor ? [this._config.floor] : [], c = Array.isArray(this._config.label) ? [...this._config.label] : [];
      this._filterInitialized || (this._lastFilter = {
        area: r,
        floor: l,
        label: c
      }, this._filterInitialized = !0);
      const d = this._lastFilter.area, h = this._lastFilter.floor, p = this._lastFilter.label, u = !J(p, c), _ = !J(h, l), b = !J(d, r), g = this._config.content === void 0;
      if (b || _ || u || g) {
        const f = this._dynamicOrder, v = this.possibleToggleDomains.map((E) => this._normalizeContentEntry(E)).sort((E, y) => {
          const V = f.indexOf(E), x = f.indexOf(y);
  ...
  _labelForTypePair(e) {
    ...
    if (t) {
      ...
      const r = this.hass.localize(`component.${n}.entity_component._.name`) || n, l = this.hass.localize(
  ...
  _classesForArea(e, t, i, s, o, n) {
    var p;
    const a = ((p = this._config) == null ? void 0 : p.extra_entities) || [], r = V1(
      s,
      o,
      n,
      this.hass.states,
    ...
    for (const u in r) {
      if (!Object.prototype.hasOwnProperty.call(r, u))
        continue;
      const _ = r[u];
      ["binary_sensor", "cover", "switch"].includes(u) ? _.forEach((b) => {
    ...
    return [...l, ...h, ...a].sort(
      (u, _) => {
        const b = d.indexOf(u), g = d.indexOf(_);
  ...
  _buildOptions(e, t, i) {
    var r;
    const s = [.../* @__PURE__ */ new Set([...t, ...i])], o = ((r = this.hass) == null ? void 0 : r.states) || {}, n = /* @__PURE__ */ new Map(), a = s.map((l) => {
      var d, h;
      if (n.has(l))
        return { value: l, label: n.get(l) };
      let c;
      return l.includes(".") ? c = ((h = (d = o[l]) == null ? void 0 : d.attributes) == null ? void 0 : h.friendly_name) || l : l === "scene" ? c = "Scene" : c = this._labelForTypePair(l), n.set(l, c), { value: l, label: c };
    });
    return a.sort((l, c) => {
      const d = l.value.includes("."), h = c.value.includes(".");
      return d && !h ? -1 : !d && h ? 1 : O1(
        l.label,
        c.label,
  ...
  _itemChanged(e, t, i) {
    ...
    if (s != null) {
      ...
      o[s] = e.detail.config, Z(this, "config-changed", {
  ...
  _renderSubElementEditor(e, t, i) {
    var l, c, d, h, p, u, _;
    const s = `_subElementEditor${e.charAt(0).toUpperCase() + e.slice(1)}`, o = this[s], n = ((d = (c = (l = this._config) == null ? void 0 : l.customization) == null ? void 0 : c[(o == null ? void 0 : o.index) ?? 0]) == null ? void 0 : d.type) ?? "unknown", a = this._labelForTypePair(n), r = ((p = (h = this._config) == null ? void 0 : h.rulesets) == null ? void 0 : p.some((b) => b.group_id === n)) ?? !1;
    return m`
      <div class="header">
  ...
  _commitRulesets() {
    ...
    e.forEach((a, r) => {
      const l = a.group_id ?? "", c = this._groupPreviousIds.get(r) ?? "";
      c && c !== l && i.set(c, l);
    });
    const s = /* @__PURE__ */ new Set(), o = [];
    for (const a of t) {
      const r = i.get(a) ?? a;
      s.has(r) || (s.add(r), o.push(r));
    }
    this._config = {
      ...this._config,
      rulesets: e,
      ...
      (a, r) => this._groupPreviousIds.set(r, a.group_id ?? "")
  ...
  _groupAllEntitiesByDomain() {
    ...
    const e = this.hass.entities || {}, t = this.hass.devices || {}, i = this.hass.areas || {}, s = {
      ...
      floor: Array.isArray((u = this._config) == null ? void 0 : u.floor) ? this._config.floor : (_ = this._config) != null && _.floor ? [this._config.floor] : [],
    ...
    ), r = this._hiddenEntitiesByDomain(), l = ((E = this.hass) == null ? void 0 : E.states) || {}, c = Array.from(
      /* @__PURE__ */ new Set([...Object.keys(a), ...Object.keys(r)])
    ).filter((y) => [...X, "person"].includes(y)), d = Ot(
      l,
      this.hass.locale.language
    );
  ...
  _hiddenEntitiesByDomain() {
    ...
    const i = this.hass.entities || {}, s = this.hass.devices || {}, o = (p = this.hass) != null && p.areas ? Object.values(this.hass.areas) : [], n = (u = this._config) == null ? void 0 : u.area, a = (_ = this._config) == null ? void 0 : _.floor, r = (b = this._config) == null ? void 0 : b.label, l = n ? Array.isArray(n) ? n : [n] : [], c = a ? Array.isArray(a) ? a : [a] : [], d = r ? Array.isArray(r) ? r : [r] : [];
    for (const g of t) {
      const f = T(g);
      if (![...X, "person"].includes(f)) continue;
      const C = i[g], v = C != null && C.device_id ? s[C.device_id] : void 0;
      if (((C == null ? void 0 : C.area_id) != null || (v == null ? void 0 : v.area_id) != null) && !(d.length && !(Array.isArray(C == null ? void 0 : C.labels) && C.labels.some((V) => d.includes(V)) || Array.isArray(v == null ? void 0 : v.labels) && v.labels.some((V) => d.includes(V)))) && !(l.length && !(C != null && C.area_id && l.includes(C.area_id) || v != null && v.area_id && l.includes(v.area_id)))) {
        if (c.length) {
  ...
  render() {
    ...
    return this._subElementEditorDomain ? this._renderSubElementEditorDomain() : this._subElementEditorEntity ? this._renderSubElementEditorEntity() : m`
      <ha-tab-group
        .hass=${this.hass}
        id="tab-group"
...
name:
  font-size: 15px;  
      ...
      ((s = this._config) == null ? void 0 : s.hide_filter) ?? ""
                ...
                ${(((o = this._config) == null ? void 0 : o.hide_filter) ?? "") === "entity" ? m`
      ...
      (n) => m`
            ...
            return m`
                                              <div class="entity-row">
                                                <span class="entity-name">
                                                  ${((c = (l = this.hass.states[r]) == null ? void 0 : l.attributes) == null ? void 0 : c.friendly_name) || r}
                                                </span>
                                                <ha-icon-button
        ...
        (a) => {
          ...
          return m`
                                      <div class="entity-row">
                                        <span class="entity-name">
                                          ${((l = (r = this.hass.states[a]) == null ? void 0 : r.attributes) == null ? void 0 : l.friendly_name) || a}
                                        </span>
                                        <ha-icon-button
        ...
        "component.group.entity_component._.name"
                      ...
                      <div class="content">
                        <ha-form
                          ...
                          .computeLabel=${this.computeLabel}
                          @value-changed=${(r) => this._groupValueChanged(r, a)}
